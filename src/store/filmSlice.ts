...
// export selectors
export const getFetchedInfo = (state: StoreSlices): Array<FilmObject> =>
  state.film.fetchedInfo;
...
export const getIfFetched = (state: StoreSlices): boolean =>
  state.film.atLeastOneFetch;
