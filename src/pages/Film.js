...
const Film = (props) => {
  ...
  const fetchedInfo = useSelector(getFetchedInfo);
  const httpIsSending = useSelector(getIsSending);
  const httpError = useSelector(getError);
  const httpAlreadyFetched = useSelector(getIfFetched);
