...
const LogInForm = () => {
    ...
    const formSubmitHandler = (event) => {
        ...
        dispatchAction(authActions.login());
    };
            ...
            <form className={styles.loginForm} onSubmit={formSubmitHandler}>
                <div className={styles.loginForm__control}>
                    ...
                    {formik.errors.username && (
                        <span className={styles.loginForm__warning}> {formik.errors.username} </span>)}
                </div>
                ...
                <div className={styles.loginForm__control}>
                    ...
                    {formik.errors.password && (
                        <span className={styles.loginForm__warning}> {formik.errors.password}  </span>)}
                </div>
                
                <div className={styles.loginForm__actions}>
                    <Button type="submit" disabled={!(formik.isValid && formik.dirty)}>Enter universe</Button>
                </div>
            </form>
        </div>
    </Fragment>;
